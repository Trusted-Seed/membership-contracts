...
describe('unit/AdminRole', () => {
  ...
  describe('#initialize', () => {
    ...
    beforeEach(() => {
      subject = async (_account: Wallet | string) =>
        await context.adminRole.initialize([typeof _account === 'string' ? _account : _account.address])
    })
  ...
  describe('#isAdmin', () => {
    ...
    beforeEach(() => {
      subject = async (_account: Wallet | string) =>
        await context.adminRole.isAdmin(typeof _account === 'string' ? _account : _account.address)
    })
  ...
  describe('#addAdmin', () => {
    ...
    beforeEach(() => {
      subject = async (_actor: Wallet, _account: Wallet | string) =>
        await context.adminRole.connect(_actor).addAdmin(typeof _account === 'string' ? _account : _account.address)
      check = async (_account: Wallet) => await context.adminRole.isAdmin(_account.address)
    })
  ...
  describe('#renounceAdmin', () => {
    ...
    beforeEach(() => {
      subject = async (_actor: Wallet) => await context.adminRole.connect(_actor).renounceAdmin()
  ...
  describe('#removeAdmin', () => {
    ...
    beforeEach(() => {
      subject = async (_account: Wallet | string, _sender: Wallet) =>
        await context.adminRole.connect(_sender).removeAdmin(typeof _account === 'string' ? _account : _account.address)
      check = async (_account: Wallet | string) =>
        await context.adminRole.isAdmin(typeof _account === 'string' ? _account : _account.address)
    })
