  ...
  describe('#changeTokenManagerContract', () => {
    ...
    before(() => {
      subject = (_tokenManagerContract: string, _sender: Wallet) =>
        context.minter.connect(_sender).setTokenManagerContract(_tokenManagerContract);
  ...
  describe('#changeTokenContract', () => {
    ...
    before(() => {
      subject = (_tokenContract: string, _sender: Wallet) =>
        context.minter.connect(_sender).setTokenContract(_tokenContract);
  ...
  describe('#changeRegistry', () => {
    ...
    before(() => {
      subject = (_registryContract: string, _sender: Wallet) =>
        context.minter.connect(_sender).setRegistry(_registryContract);
